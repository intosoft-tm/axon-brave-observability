    ...
    BehaviorSpec(
        {
            context("span factory is available") {
                given("message is created") {
                    ...
                    val observationRegistry: TestObservationRegistry = mockk()
                ...
                given("span attribute provider is available") {
                    ...
                    `when`("create handler span adds attributes") {
                        braveSpanFactory
                            .createLinkedHandlerSpan({ "MyRootTrace" }, message)
                            .start()
                            .makeCurrent()
                    ...
                    `when`("create dispatch span adds attributes") {
                        braveSpanFactory
                            .createDispatchSpan({ "MyRootTrace" }, message)
                            .start()
                            .makeCurrent()
                    ...
                    `when`("create internal span adds attributes") {
                        braveSpanFactory
                            .createInternalSpan({ "MyRootTrace" }, message)
                            .start()
                            .makeCurrent()
